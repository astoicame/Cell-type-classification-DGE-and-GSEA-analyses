...
table(expdata$grade)
# Look at gene expression data
dim(exprs(expdata))
# Look at participant data, phenotype data
dim(pData(expdata))
...
# Pull from the ExpressionSet object
...
# Look at feature data;gene data
...
# Check the first few rows of each component
...
# Create dataframe to be used in volacano plot
